/** Content for the six service pages, ported from the Next.js page components. */
export const servicePages = [
  {
    ...
    feeNote:
      "A limited number of reduced-fee places are held at any time. If cost is the only thing standing between you and this work, say so in your first conversation.",
  ...
  },
  {
    ...
    feeNote:
      "One fee covers both of you, including the individual sessions in weeks two and three.",
    ctaLabel: "Book a free conversation",
  ...
  },
  {
    ...
    feeNote:
      "Frequently paid for by parents or as an engagement gift. Say so when you book and I will handle the arrangement discreetly.",
  ...
  },
  {
    ...
    feeNote:
      "Gift vouchers are available. This makes an unusually good anniversary or wedding present, and it is regularly bought as one.",
  ...
  },
  {
    ...
    feeNote:
      "Travel outside Port Harcourt is quoted separately at cost. Dates are held on receipt of the deposit and are limited by design — this format only works if I am not running them back to back.",
  ...
  },
  {
    ...
    feeNote:
      "Use the currency switch above to see these in pounds or dollars. Diaspora rates reflect the out-of-hours scheduling; standard rates apply for daytime West Africa slots.",
    ctaLabel: "Book a free conversation",
